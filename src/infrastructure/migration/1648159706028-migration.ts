...
export class migration1648159706028 implements MigrationInterface {
    name = 'migration1648159706028'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE \`book\` (\`id\` int NOT NULL AUTO_INCREMENT, \`name\` varchar(255) NOT NULL, \`description\` varchar(255) NOT NULL, \`author\` varchar(255) NOT NULL, \`releaseAt\` datetime NOT NULL, \`imageUrl\` varchar(255) NOT NULL, \`fileUrl\` varchar(255) NOT NULL, \`approved\` int NOT NULL, \`userId\` int NOT NULL, \`categoryId\` int NOT NULL, \`createdAt\` datetime NOT NULL, \`updatedAt\` datetime NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
